<%@ Page Title="WebApp.Content.i18n.BackOffice.WorldWideEvents.Index" Language="C#"
    MasterPageFile="~/Areas/BackOffice/Views/Shared/BackOffice.Master" Inherits="System.Web.Mvc.ViewPage<IEnumerable<DAL.WorldWideEvent>>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <h2>
        <%:WebApp.Content.i18n.BackOffice.WorldWideEvents.Index %></h2>
    ...
    <%}
       ...
       {%>
    <%:  WebApp.Content.i18n.BackOffice.WorldWideEvents.NoItems%>
    <%}        
    %>
    <p>
