...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                ...
                |
                <%: Html.ActionLink("Roles", "Roles", new { id=item.Id }) %>
                |
    ...
    <%}
       ...
       {%>
    <%:  WebApp.Content.i18n.BackOffice.Users.NoItems%>
    <%}        
    %>
    <p>
        <h2>
            <%: Html.ActionLink(WebApp.Content.i18n.BackOffice.Users.ViewNonApproved, "NonApproved")%></h2>
    </p>
    <p>
        <strong>
