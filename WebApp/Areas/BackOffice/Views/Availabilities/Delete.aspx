...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <fieldset>
        ...
        <div class="display-label"><%:WebApp.Content.i18n.BackOffice.Availabilities.Id %></div>
        ...
        <div class="display-label"><%:WebApp.Content.i18n.BackOffice.Availabilities.UserId %></div>
